# -*- coding: utf-8 -*-
"""
Created on Mon Jan 20 16:08:03 2020
...
setup(
  ...
  name = 'topsis_Aditri_3034',         # How you named your package folder (MyLib)

  packages = ['topsis_Aditri_3034'],   # Chose the same as "name"

  version = '0.1',      # Start with a small number and increase it with every change you make

  license='MIT',        # Chose a license from here: https://help.github.com/articles/licensing-a-repository

  description = 'Implementing the TOPSIS method in python',   # Give a short description about your library
